...
shinyUI(dashboardPage(skin="red",
                      ...
                      dashboardHeader(title = "EUROPE ENERGY  "),
                      dashboardSidebar(
    ...
    tabItems(
      ...
      tabItem(tabName='clustermap',
              ...
              absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE, draggable = TRUE,
                            ...
                            checkboxGroupInput(inputId = "type2", label = h4("Select Power Type"),
              ...
              tags$head(
                tags$style(type = "text/css", "#heatmap {height: calc(100vh - 80px) !important;}"
                         ...
                         absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE, draggable = TRUE,
                                       ...
                                       checkboxGroupInput(inputId="type", label=h4("Select Power Type"),
                                                   choices=choice1, selected='pole')
                  )),
